...
You must be at least 13 years old to use Microhabit. If local law requires a higher age, you must meet that requirement.
...
You must not share your account in a way that compromises the service or other users.
...
- Reverse engineer or abuse the app, infrastructure, or security controls

## User Content and League Activity

You are responsible for the content and activity data you submit, including names, league information, and check-ins.

You represent that the information you provide does not violate applicable law or the rights of others.
...
You may stop using Microhabit at any time and may request account deletion through the app when available.
